    ...
    @section('content')
        <div class="w-full md:h-[90vh] h-fit bg-gradient-to-tr from-pr-400 to-pr-700 pb-8 md:pb-0 ">
            <div
                class="max-w-screen-xl mx-auto flex md:flex-row flex-col  justify-between items-center h-full md:px-12 px-3">
                <div class="md:w-1/2 w-full flex flex-col items-center md:justify-center gap-2 md:h-[32rem] my-8 md:my-0  ">
                    ...
                    <img src="./assets/illustrations/login.png" alt=""
                        class="md:w-3/5 w-1/3 h-fit order-1 md:order-2   object-cover ">
                </div>
                <div
