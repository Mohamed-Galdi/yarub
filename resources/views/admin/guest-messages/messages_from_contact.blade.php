            ...
            <table class="w-full text-left rtl:text-right text-gray-500 ">
                <thead class="text-lg  text-gray-700 uppercase bg-gray-300 w-full">
                    <tr>
                        ...
                        <th scope="col" class="ps-8 py-3 w-[12.5%] ">
                            الإسم
                        </th>
                        <th scope="col" class="ps-8 py-3 w-[12.5%] ">
                            البريد الإلكتروني
                        </th>
                        <th scope="col" class="ps-8 py-3 w-1/2 ">
                            الرسالة
                        </th>
                ...
                <tbody>
                    @forelse ($messages_from_contact as $message)
                        <tr data-modal-target="message-modal-{{ $message->id }}"
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <p class=" text-nowrap truncate w-32">{{ $message->name }}</p>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <p class=" text-nowrap truncate w-32">{{ $message->email }}</p>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <p class=" text-nowrap truncate">{{ Str::words($message->message, 8, '...') }}</p>
                                </div>
                            </td>
                            <td>
                                <p class=" text-nowrap truncate w-32">
