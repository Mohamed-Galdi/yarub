<div
    {{ $attributes->merge(['class' => 'w-full h-fit bg-gradient-to-tr from-indigo-400 to-indigo-600 flex  justify-between items-center gap-4 rounded-xl p-2 overflow-hidden shadow-lg cursor-pointer hover:shadow-none hover:scale-[1.01] transition-all duration-300 ease-in-out']) }}>
