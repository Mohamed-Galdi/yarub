<div
    class="bg-gray-200 w-1/4  flex flex-col items-start justify-start border-2 border-pr-500 overflow-hidden
    ...
    <div class="px-6 pt-2 w-full">
        <p class="text-2xl font-bold text-pr-500 mb-1 truncate">{{ $title }}</p>
        <p class="font-nitaqat font-bold text-lg truncate ">{{ $description }}</p>
