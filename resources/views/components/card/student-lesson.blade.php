 <div
     {{ $attributes->merge(['class' => 'w-full h-96 bg-gradient-to-tr from-teal-800 to-teal-400 rounded-xl shadow-lg p-4 space-y-4 overflow-hidden']) }}>
     ...
     <div class=" text-white justify-between items-center">
         ...
         <div dir="ltr" class="w-full h-4 bg-gray-200 rounded-xl p-[2px] float-end ">
             <div class="h-full  bg-gradient-to-l rounded-md to-sky-900 from-green-400"
     ...
     <div class="pt-3">
         <x-btn.enrol class="" route="admin.courses.edit" id="{{ $lessonId }}">إستكمال</x-btn.enrol>
     </div>
 </div>
